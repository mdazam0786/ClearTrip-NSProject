    ...
    <div className="footer-container">
      ...
      <Link to="/comingSoon" className="nav-link">
        <p className="heading-flight-hotel">
          Delhi Goa flights Mumbai Delhi flights Delhi Kolkata flights Pune Delhi
          flights Bangalore Delhi flights Mumbai Bangalore flights Chennai Delhi
          flights Kolkata Delhi flights Delhi Mumbai flights Delhi Bangalore
          flights Mumbai Goa flights
        </p>
      </Link>
      <h4 className="heading-flight-hotel">Popular International Flight Routes</h4>
      <Link to="/comingSoon" className="nav-link">
        <p className="heading-flight-hotel">
          Delhi Singapore flights Delhi Bangkok flights Mumbai Dubai flights Delhi
          Dubai flights Delhi to London flights Delhi to Toronto flights Delhi to
          New york flights Bangalore to Singapore flights Delhi to Paris flights
          Mumbai to Paris flights Delhi to Hong Kong flights
        </p>
      </Link>
      ...
      <Link to="/comingSoon" className="nav-link">
        <p className="heading-flight-hotel">
          Cheap air tickets Flight tickets India Hotels Cheap Domestic Air Tickets
          Domestic Flights Domestic Airlines in India International Air Tickets
          International Flights International Airlines Holiday Packages
        </p>
      </Link>
